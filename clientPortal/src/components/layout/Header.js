...
function Header({
  ...
  return (
    <>
      <div className="setting-drwer" onClick={showDrawer} hidden={isDesktop}>
        📰
      </div>
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
        ...
        <Col span={24} md={18} className="header-control">
          ...
          >
            <div layout="vertical">
              ...
              <Col xs={24} style={{ margin: 0, padding: 0}}>
          ...
          <Link to="/sign-in" className="btn-sign-in" hidden={CPreMM_account!==null}>
            {profile}
            <span>Sign in</span>
          </Link>
          <Button 
          className="btn-sign-in" type="link"
          hidden={CPreMM_account===null}
          onClick={()=>{
            const confirm = window.confirm("Are you sure you want to logout?")
            if(confirm){
              localStorage.removeItem("CPreMM_JWT")
